...
<template>
    <div class="flex h-full items-center justify-center bg-gray-900">
        <div class="bg-no-repeat w-full h-full relative" @click="next">
            <div background class="absolute z-0 flex items-center justify-center w-full">
            ...
            <div text class="fixed grid grid-row-6 h-full w-full z-10">
                ...
                <div class="row-span-1 flex flex-col-reverse">
                    <div class="flex pl-2">
                        ...
                        >{{ page.avatar[0].name }}</div>
                        <div class="flex-grow"></div>
                    </div>
                </div>
                <div
                    class="row-span-1 flex flex-col items-center w-full justify-center bg-opacity-65 border border-white border-solid rounded bg-white z-10 px-10"
                >
